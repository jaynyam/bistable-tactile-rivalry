%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%Realingment Localizer%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%

function realignment_localizer
...
datapath = '/Users/nelebehrens/Documents/data/methods_fMRI/sub-003/Analysis/run_7'; %CHANGE PATH - run-folder
cd(datapath);
